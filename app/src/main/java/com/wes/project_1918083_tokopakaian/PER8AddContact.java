...
import com.wes.project_1918083_tokopakaian.databinding.ActivityPer8AddContactBinding;
import java.io.ByteArrayOutputStream;
public class PER8AddContact extends AppCompatActivity {
    private ActivityPer8AddContactBinding binding;
    PER8DBmain dBmain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPer8AddContactBinding.inflate(getLayoutInflater());
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rec != null) {
                    Intent a = new Intent(PER8AddContact.this, PER8MainActivity4.class);
                    startActivity(a);
                    Toast.makeText(PER8AddContact.this, "Data Inserted", Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(PER8AddContact.this, "Something Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
        //for view display
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent( PER8AddContact.this, PER8MainActivity4.class));
            }
        });
        ...
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(recedit != -1){
                    Toast.makeText(PER8AddContact.this, "Update Succesfully", Toast.LENGTH_SHORT).show();
