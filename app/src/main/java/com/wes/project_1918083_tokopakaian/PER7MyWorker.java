...
public class PER7MyWorker extends Worker {
    public PER7MyWorker(@NonNull Context context, @NonNull
    ...
    public Result doWork() {
        displayNotification("1918083 - WAHYU EKA SAPUTRA", " Teknik Informatika S-1");
