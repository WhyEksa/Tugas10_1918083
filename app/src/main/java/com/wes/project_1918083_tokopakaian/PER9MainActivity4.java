...
import com.wes.project_1918083_tokopakaian.databinding.ActivityPer9Main4Binding;
...
public class PER9MainActivity4 extends AppCompatActivity implements View.OnClickListener {
    private ActivityPer9Main4Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPer9Main4Binding.inflate(getLayoutInflater());
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_pp){
                    Intent a = new Intent(PER9MainActivity4.this, MainActivity.class);
                    startActivity(a);
                }else if (id == R.id.nav_pw){
                    Intent a = new Intent(PER9MainActivity4.this, MainActivity2.class);
                    startActivity(a);
                }else if (id == R.id.nav_by){
                    Intent a = new Intent(PER9MainActivity4.this, MainActivity3.class);
                    startActivity(a);
                }else if (id == R.id.nav_per6){
                    Intent a = new Intent(PER9MainActivity4.this, PER6MainActivity4.class);
                    startActivity(a);
                }
                else if (id == R.id.nav_per8){
                    Intent a = new Intent(PER9MainActivity4.this, PER8MainActivity4.class);
                    startActivity(a);
                }
                else if (id == R.id.nav_per9){
                    Intent a = new Intent(PER9MainActivity4.this, PER9MainActivity4.class);
                    startActivity(a);
                }
                else if (id == R.id.nav_per10){
                    Intent a = new Intent(PER9MainActivity4.this, PER10LoginActivity.class);
                    startActivity(a);
                    editor.clear();
                    editor.commit();
                }
    ...
    class DOTask extends AsyncTask<URL, Void, String>{
        ...
        protected String doInBackground(URL... urls) {
            ...
            String data = null;
            try {
                data = PER9NetworkUtils.makeHTTPRequest(url);
            }catch (IOException e){
                e.printStackTrace();
            }
            return data;
